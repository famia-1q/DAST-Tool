...
- **Framework Mapping:** 
  - Web/API findings map to OWASP ASVS and CIS Benchmarks.
  - Mobile findings map to OWASP MASVS (Mobile Application Security Verification Standard).
...
4. **Pull required Docker images (Optional, happens automatically on first run):**
